...
/*   Updated: 2024/03/20 22:11:17 by jonathanebe      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	smart_print(char type, va_list args)
{
	...
	//else if (type == 'u')
	//{
	//	count = smart_print_u(va_arg(args, int));
	//}
	//else if (type == 'x')
	//{
	//	count = smart_print_x(va_arg(args, int));
	//}
	//else if (type == 'X')
	//{
	//	count = smart_print_xup(va_arg(args, int));
	//}
	//else if (type == '%')
	//{
	//	count = smart_print_c('%');
